...
\begin{document}
\pgfplotstableset{
	create on use/g/.style={
	    create col/expr={
	    (1-sqrt(\thisrow{emin2}/\thisrow{emax2}))/
	    	(1+sqrt(\thisrow{emin2}/\thisrow{emax2}))
	    }
	},
}
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		legend style={
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=*, line width=1.2pt, mark size=1.5pt, solid,blue] plot [error bars/.cd, y dir = both, y explicit] table [ x=Dx, y=g, ] {../data/ex3.tsv};
